# atomic_zerotier_install
This is a repo for a custom script that installs Zerotier easily on Fedora atomic desktops such as Fedora Silverblue, Bazzite, etc. 
